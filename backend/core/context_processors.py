...
#
#  Верхний уровень содержит одиннадцать пунктов, что удовлетворяет требованию
#  к объёму навигации и одновременно остаётся обозримым: тематически близкие
...
MAIN_NAV: tuple[NavItem, ...] = (
    ...
    NavItem(
        ...
        (
            ...
            NavItem(
                ...
                _("Подбор площадки"),
                "analytics:siting",
                _("Отбор площадок под требования перевозчика"),
            ),
        ),
    ),
    NavItem(
        ...
        _("Допуск"),
        "core:permit_check",
        _("Условия проезда грузового транспорта по городу"),
        (
            NavItem(
                "permits",
                _("Условия допуска"),
                "core:permit_check",
                _("Какой пропуск требуется и что ограничивает проезд"),
            ),
            NavItem(
                "zones",
                _("Зоны ограничения"),
                "core:zone_list",
                _("МКАД, Третье транспортное и Садовое кольцо"),
            ),
        ),
    ),
    NavItem(
    ...
    NavItem(
        ...
        (
            ...
            NavItem(
                "spatial",
                _("Пространственный анализ"),
                "analytics:spatial",
                _("Картограмма и зоны обслуживания"),
            ),
            NavItem("forecast", _("Прогноз грузопотока"), "analytics:forecast", _("Продолжение ряда перевозок")),
