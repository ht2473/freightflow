...
#: Наибольший масштаб, до которого карта увеличивается на экране. Тайлы
#: собираются до шестнадцатого; дальше клиент растягивает последний, и это
#: верно — подробнее исходных данных карта всё равно не станет.
CLIENT_MAX_ZOOM = 18
